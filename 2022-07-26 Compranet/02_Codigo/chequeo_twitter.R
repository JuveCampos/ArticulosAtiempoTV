...
mas_menos <- data_tweets %>%
  arrange(-retweet_count) %>%
  select(created_at, screen_name, text, contains("url"))

write_csv(mas_menos, "02_Codigo/mas_menos_2.csv")
openxlsx::write.xlsx(mas_menos %>% select(-contains("url")),
                     "02_Codigo/mas_menos_2.xlsx")
